...
public class TdGenerator extends TextileGenerator {
    ...
    public void write(Element element, String name, NamedNodeMap attributes, NodeList children, BufferedWriter out) throws IOException {
        if (attributes.getLength() != 0) {
            writeColOrRowSpan(attributes, "rowspan", '/', out);
            writeColOrRowSpan(attributes, "colspan", '\\', out);
    ...
    private void writeColOrRowSpan(NamedNodeMap attributes, String attributename, char outSymbol, BufferedWriter out) throws IOException {
