...
public class RegexTransformationRuleSet_Test {
    ...
    public void test1() throws IOException {
        ...
        RegexTransformationRuleSet rules = new RegexTransformationRuleSet();
        String res = rules.transform("abc|;|&nbsp;|&lsquo;|&rsquo;|&|xyz","HTML_PREPROCESSING",false);
    ...
    public void test2() throws IOException {
        ...
        RegexTransformationRuleSet rules = new RegexTransformationRuleSet(new File(SANDBOX_INPUT));
        String res = rules.transform("abc|;|&nbsp;|&lsquo;|&rsquo;|&|xyz","HTML_PREPROCESSING",false);
        assertEquals("abc|;| |'|!!!|&|xyz",res);
    }
    ...
    public void test3() throws IOException {
        ...
        RegexTransformationRuleSet rules = new RegexTransformationRuleSet();
        String res = rules.transform("font-family:serif;font-size:12pt;font-size:10pt;font-size:18pt;color:#000000;color:#ffffff;","HTML_STYLE_PROCESSING",false);
    ...
    public void test9() throws IOException {
        ...
        RegexTransformationRuleSet rules = new RegexTransformationRuleSet(new File(SANDBOX_INPUT));
        String res = rules.transform("abc|;|&nbsp;|&lsquo;|&rsquo;|&|xyz","HTML_PREPROCESSING",true);
