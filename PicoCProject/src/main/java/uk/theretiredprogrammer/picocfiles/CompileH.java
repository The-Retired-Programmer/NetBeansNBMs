...
@ActionID(
        category = "Build",
        id = "uk.theretiredprogrammer.picocfiles.compileh"
)
@ActionRegistration(
        displayName = "#CTL_CompileH"
)
@ActionReference(path = "Loaders/text/x-picoh/Actions", position = 150)
@Messages("CTL_CompileH=Compile")
public final class CompileH implements ActionListener, Runnable {

    private final List<DataObject> context;

    public CompileH(List<DataObject> context) {
